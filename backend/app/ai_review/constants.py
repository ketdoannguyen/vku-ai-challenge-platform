...
# Provider trả 200 và đúng giao thức, nhưng câu trả lời không vừa ngân sách output của mình - khác
# hẳn "body hỏng", nên phải là mã riêng: đây là lỗi cấu hình chứ không phải lỗi của provider.
