...
- Consequences:
  ...
  - `client_max_body_size 12m` của Nginx vẫn là giới hạn body hiệu lực; Workers không cấu hình body limit trong file này, nên hành vi biên khi vượt ngưỡng là `413` từ Nginx.
...
- Date: 2026-09-19
- Status: accepted (chưa bật trên production - xem "Rollout")
